...
const DEFAULT_BACKGROUND_NOISE_ENABLED = true;
const DEFAULT_BACKGROUND_NOISE_OPACITY = 0.35;
const DEFAULT_BACKGROUND_NOISE_SCALE = 360;
const DEFAULT_BACKGROUND_NOISE_CONTRAST = 0.25;
